 ...
 */
 ...
 PNG_DFN "" 
 PNG_DFN "/* libpng version 1.6.16,December 22, 2014 */" 
 PNG_DFN "" 
 PNG_DFN "/* Copyright (c) 1998-2014 Glenn Randers-Pehrson */" 
 PNG_DFN "" 
...
#endif /*requires, if*/
#ifndef  PNG_on
 PNG_DFN "/*#undef PNG_SAFE_LIMITS_SUPPORTED*/" 
#endif
 ...
 *   requires:  
 *   if:        
 *   enabled-by: ARM_NEON_API READ READ_sRGB WRITE_sRGB
 *   sets:       */
#undef PNG_on
#define PNG_on 1
#undef PNG_no_if
...
#endif /*requires, if*/
#ifndef  PNG_on
 PNG_DFN "/*#undef PNG_SET_CHUNK_CACHE_LIMIT_SUPPORTED*/" 
#endif
...
#endif /*requires, if*/
#ifndef  PNG_on
 PNG_DFN "/*#undef PNG_SET_CHUNK_MALLOC_LIMIT_SUPPORTED*/" 
#endif
 ...
 *   requires:   WRITE STDIO SETJMP WRITE_SWAP WRITE_PACK WRITE_tRNS WRITE_gAMA WRITE_sRGB WRITE_cHRM
 *   if:        
 *   enabled-by:
 *   sets:       */
#undef PNG_on
 ...
 *   default:   3 3 */
 ...
 PNG_DFN "#define PNG_COST_SHIFT @" PNG_COST_SHIFT "@" 
#else /* use default */
# ifdef PNG_set_COST_SHIFT
 PNG_DFN "#define PNG_COST_SHIFT @" PNG_set_COST_SHIFT "@" 
#  define PNG_COST_SHIFT 1
# else /*default*/
 PNG_DFN "#define PNG_COST_SHIFT 3" 
#  define PNG_COST_SHIFT 1
# endif /* defaults */
#endif /* setting COST_SHIFT */

/* setting:  WEIGHT_SHIFT
 *   requires:
 *   default:   8 8 */
#ifdef PNG_WEIGHT_SHIFT
 PNG_DFN "#define PNG_WEIGHT_SHIFT @" PNG_WEIGHT_SHIFT "@" 
#else /* use default */
# ifdef PNG_set_WEIGHT_SHIFT
 PNG_DFN "#define PNG_WEIGHT_SHIFT @" PNG_set_WEIGHT_SHIFT "@" 
#  define PNG_WEIGHT_SHIFT 1
# else /*default*/
 PNG_DFN "#define PNG_WEIGHT_SHIFT 8" 
#  define PNG_WEIGHT_SHIFT 1
# endif /* defaults */
#endif /* setting WEIGHT_SHIFT */
